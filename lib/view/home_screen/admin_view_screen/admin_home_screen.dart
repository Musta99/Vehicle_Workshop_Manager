                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        "Do you want to delete " +
                                                                            "Service No: " +
                                                                            snapshot.data!.docs[index]["vehicleregistrationNumber"],
                                                                        textAlign:
                                                                            TextAlign.center,
                                                                        style: GoogleFonts.roboto(
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                decoration: BoxDecoration(
                                                                                  border: Border.all(color: Color(0xffAFBBC6)),
                                                                                  borderRadius: BorderRadius.circular(MediaQuery.of(context).size.height * 0.0086),
                                                                                ),
                                                                                child: Center(
                                                                                  child: Text("Cancel"),
                                                                                ),
                                                                          ...
                                                                          GestureDetector(
                                                                            onTap:
                                                                                () async {
                                                                              await FirebaseCloudStore().deleteReservation(snapshot.data!.docs[index]["vehicleregistrationNumber"]);
